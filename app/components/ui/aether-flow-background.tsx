...
// The background animation component (without text content)
    ...
    React.useEffect(() => {
        ...
        function init() {
            ...
            for (let i = 0; i < numberOfParticles; i++) {
                ...
                // Using purple colors that match Apv3rse theme with lower opacity for subtlety
                let color = 'rgba(191, 128, 255, 0.4)'; // Softer purple
        ...
        const animate = () => {
            ...
            // Set a dark background with slight transparency for blending
